package com.ptu.mata.myapplition;
...
public class MyApplication extends Application {
    ...
    //获取定位地址的城市名称,定义方法传给需要活动
    private String cityName;

    @Override
    public void onCreate() {
        super.onCreate();
        RetrofitUseCache.init(this);
        x.Ext.init(this);
        x.Ext.setDebug(true);

        ShareSDK.initSDK(this);

       // ImmerseUtils.getContext((Activity) getApplicationContext());
...
//        filter.addAction(WifiManager.WIFI_STATE_CHANGED_ACTION);
        ...
        registerReceiver(new NetReceiver(), filter);
    }
    ...
    public boolean netState() {
        ...
        if (cManager.getActiveNetworkInfo() == null) {
            Toast.makeText(getApplicationContext(), "当前没网络哦亲！", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }

    //动态注册广播，随时监听手机网络状态，提醒用户
